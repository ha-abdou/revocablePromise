...
describe('Working cases:', function () {
    it('should work without error: init single promise', function (done) {
        const q = new index_1.default(new Promise(() => done()));
    });
    ...
    it('should work without error: init array of promises', function (done) {
        const q = new index_1.default([
            new Promise(() => done()),
            new Promise(() => { }),
        ]);
    });
    it('should return the correct response:', function (done) {
        const q = new index_1.default(new Promise((res, rej) => res(42)));
        q.then((data) => {
    ...
    it('should return the correct error', function (done) {
        const q = new index_1.default(new Promise((res, rej) => setTimeout(() => rej(42), 5)));
        q.then((data) => {
    ...
    it('should return the correct responses', function (done) {
        const q = new index_1.default([new Promise((res, rej) => res(24)),
    ...
    it('should return the correct errors', function (done) {
        const q = new index_1.default([new Promise((res, rej) => setTimeout(() => rej(24), 5)),
    ...
    it('should return the correct response', function (done) {
        const q = new index_1.default(new Promise((res, rej) => setTimeout(() => res(42), 10)));
        q.minTimeout = 5;
        q.then((data) => {
            chai_1.assert.equal(data, 42);
            done();
...
describe("Test revoked:", () => {
    it('should revoke the promise', function (done) {
        const q1 = new index_1.default(new Promise((res, rej) => setTimeout(() => res(), 5)));
        const q2 = new index_1.default(new Promise((res, rej) => setTimeout(() => rej(), 5)));
        q1.revoke();
        q2.revoke();
        q1.then(() => {
            done();
    ...
    it('should revoke the promise', function (done) {
        const q1 = new index_1.default([
            new Promise((res, rej) => setTimeout(() => res(), 5)),
            new Promise((res, rej) => setTimeout(() => res(), 5))
        ]);
        const q2 = new index_1.default([
...
describe("Test min timeout:", () => {
    it('should wait before callback', function (done) {
        const q = new index_1.default(new Promise((res, rej) => setTimeout(() => res(), 5)));
        const t = Date.now();
        q.minTimeout = 20;
        q.then(() => {
            if (Date.now() - t >= 20) {
